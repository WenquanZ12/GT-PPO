...
def generate_TFN(b):
    """
    Generate a Triangular Fuzzy Number (TFN) (a, b, c) for a given crisp processing time b.
    a and c are randomly chosen in the interval [0, b/2].

    Parameters:
        b (int): The crisp processing time.

    Returns:
        tuple: A Triangular Fuzzy Number (a, b, c).
    """
